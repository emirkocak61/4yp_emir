...
class ApproachTargetStandaloneArmActionServer : public MotionPlannerStandaloneArmBaseClass {

public:
    ApproachTargetStandaloneArmActionServer() 
        //Call the constructor of the base class
        : MotionPlannerStandaloneArmBaseClass("approachTarget"), 
        robot_name("unitree"),
        //Instantiate the action server
        as_(nh_, action_name + "_as", boost::bind(&ApproachTargetStandaloneArmActionServer::execute_cb, this, _1), false)
    {
